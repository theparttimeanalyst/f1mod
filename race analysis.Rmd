...
austria_gp_2023 <- data.frame(
  ...
  Stint_2 = c("C3", "C4", "C4", "C4", "C4", "C3", "C4", "C3", "C3", "C3", "C3", "C3", "C3", "C3", "C3", "C4", "C3", "C3", "C4", "C3"),
...
all_race_strat = all_race2 %>% left_join(strat_sum, by = c("code", "stint", "raceId")) %>%
                                    group_by(code, stint) %>%
                                      mutate(sitntl = 1:n()) %>%
                                          ungroup()
