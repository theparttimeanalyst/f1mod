...
data <- tribble(
  ...
  "PER", "Red Bull", "C3", "C3", "C5", "C1", "C1",
  "NOR", "McLaren", "C4", "C3", "C1", "C2",
  "HUL", "Haas", "C4", "C3", "C2", "C2",
  "PIA", "McLaren", "C4", "C3", "C3", "C1", "C1",
  "ZHOU", "Alfa Romeo", "C1", "C3", "C3", "C1",
  "TSU", "AlphaTauri", "C4", "C3", "C3", "C2", "C2",
  "BOT", "Alfa Romeo", "C1", "C3", "C1",
  "SAI", "Ferrari", "C5", "C3", "C2", "C2",
  "GAS", "Alpine", "C1", "C3", "C2",
  "OCO", "Alpine", "C1", "C3", "C1",
  "DEV", "AlphaTauri", "C3", "C4", "C1", "C2",
  "SAR", "Williams", "C3", "C5", "C5", "C4", "C5", "C1",
  "MAG", "Haas", "C4", "C3",
  "RUS", "Mercedes", "C4", "C3",
  "ALB", "Williams", "C4",
  "LEC", "Ferrari", "C4"
